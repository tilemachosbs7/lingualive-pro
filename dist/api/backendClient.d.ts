 ...
 */
export declare function buildAuthHeaders(settings: LinguaLiveSettings): AuthHeaders;
/**
 ...
 */
export declare function fetchUserBootstrap(settings: LinguaLiveSettings, sessionLimit?: number): Promise<UserBootstrapResponse>;
/**
 ...
 * }
 */
export declare function fetchUserLimitsSummary(settings: LinguaLiveSettings): Promise<UserLimitsSummary>;
/**
 ...
 */
export declare function fetchUserUsageSummary(settings: LinguaLiveSettings): Promise<PublicUserUsageSummary>;
/**
 ...
 */
export declare function fetchPublicStatus(backendBaseUrl: string, timeoutSeconds?: number): Promise<PublicStatusResponse>;
/**
 ...
 */
export declare function requestDevToken(backendBaseUrl: string, settings: LinguaLiveSettings, ttlMinutes?: number): Promise<DevTokenResponse>;
/**
 ...
 * }
 */
export declare function revokeDevToken(backendBaseUrl: string, settings: LinguaLiveSettings): Promise<DevTokenRevokeResponse>;
export {};
