...
type TabCaptureMessage =
  | { type: "LLP_START_TAB_CAPTURE" }
  | { type: "LLP_STOP_TAB_CAPTURE" };
  ...
  try {
    ...
    recorder.ondataavailable = async (event: BlobEvent) => {
      ...
      try {
        ...
        const message: TabAudioChunkMessage = {
          type: "LLP_TAB_AUDIO_CHUNK",
          buffer,
          timestampMs,
        };
 ...
 */
function handleStopTabCapture(): void {
